...
const isVPS = !(__dirname.startsWith("/rgnk") || __dirname.startsWith("Akash"));
const isHeroku = __dirname.startsWith("Akash");
...
module.exports = {
    ...
    BOT_INFO: process.env.BOT_INFO || '𝙳𝙰𝚁𝙺𝙰𝙻𝙿𝙷𝙰𝚇𝚃𝙴𝙰𝙼;dark shadow_official;0;https://i.imgur.com/P7ziVhr.jpeg;https://chat.whatsapp.com/Dt3C4wrQmt0GG6io1IBIHb',
    ...
    SUDO: process.env.SUDO || "94787820101",
